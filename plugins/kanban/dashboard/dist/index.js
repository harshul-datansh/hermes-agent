  ...
  function ClientReviewPanel() {
    ...
    return h(Card, { className: "p-3" }, h(CardContent, { className: "p-2 flex flex-col gap-2" },
      ...
      state ? h("div", { className: "text-xs flex flex-wrap gap-x-3 gap-y-1" },
        ...
        doctorData && (doctorData.checks || []).some(function (check) { return check.name === "GitHub PR delivery" && !check.ok; }) ? h("span", { className: "text-destructive" }, "PR delivery needs GitHub access") : null,
